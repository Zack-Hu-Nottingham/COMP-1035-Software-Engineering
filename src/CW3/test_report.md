...
|**[TS-Category 8-1]**|**[Result]:** `Fail` **[Time]:**<br>2021/04/24 18:12<br>**[Tester]:**<br>Lin Chen (biylc2) **[Platform]**: Windows10-IDEA<br>![](testLog\TS-Category-8-1.png)|**[Modifier]:**<br> Lin Chen (biylc2) <br> **[Content (A)]:**<br>`if(valueToAdd == null){throw new NullPointerException("Illegal input");}`<br> ||||
