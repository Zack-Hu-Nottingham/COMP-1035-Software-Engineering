...
* Tasks:
  1. Design the team [workflow](#workflow) and documentation system to ensure work efficiency and traceability;
  2. Define [standards](#standards) and make sure all of the doucumented / changed file meets the requirements
  ...
  7. Help team members with technical issues and introduce useful [methods]() to solve the problem.
...
1. **[Milestone]** : "".
   ...
   **[Duedate]**:
    * **[]** `Team A`: ~Done #6 make test plan and implement test code for `BoCTransaction` on a separated branch <!4>.
    * **[]** `Team B`: ~Done #7 make test plan and implement test code for `BoCCategory` on a separated branch <!2>.
    * **[]** `Team C`: ~Done #7 make test plan and implement test code for `BoCCategory` on a separated branch <!2>.

    * **[Problem solving]** ~ Cannot open idea projects using Eclipse.
    ...
    * **[OfficeHour]** ~Ask teacher the list of 
    problems we encountered [Question]()
...
2. **[Milestone]** "".
    **[Duedate]**:
    * **[Assign & [+ Branch +]]** `Team A`: ~Done #20 Fix `BoCTransaction` following TDD on a separated branch <!5>.
    * **[]**
    * **[Assign & [+ Branch +]]** `Team B`: ~Done #21 Fix `BoCCategory` following TDD on a separated branch <!6>.
...
3. **[Milestone]** "".
    ...
    **[Duedate]**:
    * **[Assign & [+ Branch +]]** `Team A`: 
    * **[]**
    * **[Assign & [+ Branch +]]** `Team B`: ~Done #21 Fix `BoCCategory` following TDD on a separated branch <!6>.
    * **[Discussion]** ~When to fix bugs: before
    the app test or after the app test
...
1. Issues
    ...
    * Each issue have a corresponding branch with a specific branch name created by Git.
