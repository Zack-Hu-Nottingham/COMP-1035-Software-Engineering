...
| ---------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| **Log In**       | <img src="prototype/log_in.png" alt="log_in" width=50% />    | This is the **interface** for the **login** **page**.<br>Users can enter their account number and password and then **access main interface** by clicking on the **login button**. |
